...
exports.answer = function(req, res) {
  var resultado = req.query.respuesta.toLowerCase() === req.quiz.respuesta.toLowerCase();
  res.render('quizes/answer', { quiz: req.quiz, respuesta: req.query.respuesta,
              esCorrecta: resultado, errors: []});
};
